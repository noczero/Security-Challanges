...
from helper.random import random_bytes, random_number
from helper.AES import ecb_encrypt, get_blocks
...
SECRET = b64decode(
    ...
    "YnkK")
KEY = random_bytes(16)
PREFIX_LEN = random_number(below=256)
...
if __name__ == '__main__':
    ...
    print("\nStatus : {}".format(plaintext == SECRET))
